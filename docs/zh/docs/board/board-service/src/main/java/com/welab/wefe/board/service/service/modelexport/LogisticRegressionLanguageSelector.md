...
| 名称   | 类型  | 说明 |
|-------|------|-------------|
| LogisticRegressionLanguageSelector | class |  |
...
|-------|-------|------|
| language | String |  |
| LANGUAGE_MAP = new HashMap<>(16) | Map<String, BaseLogisticRegressionLanguage> |  |

### 方法列表

| 名称  | 类型  | 说明 |
|-------|-------|------|
| getSelector | BaseLogisticRegressionLanguage |  |

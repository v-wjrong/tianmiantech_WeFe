...
| Name | pir |
| Language | .java |
| Code Path | WeFe/mpc/mpc-pir/mpc-pir-sdk/src/main/java/com/welab/wefe/mpc/pir |
| Package Name | docs.mpc.mpc-pir.mpc-pir-sdk.src.main.java.com.welab.wefe.mpc.pir |
...
graph TD
    ...
    pir --> PrivateInformationRetrievalQuery.java
```

This flowchart illustrates the complete directory structure of the MPC-PIR-SDK module, starting from the root directory 'pir' and hierarchically expanding into subdirectories such as 'sdk' and its subordinate modules like 'trasfer', 'naor', 'query', etc. Each module contains corresponding implementation classes and interface files, such as HttpTransferVariable.java, NaorPinkasQuery.java, etc., clearly presenting the hierarchical relationships between components.

...
| Name | wefe |
| Language | .java |
| Code Path | WeFe/mpc/mpc-sa/mpc-sa-sdk/src/main/java/com/welab/wefe |
| Package Name | docs.mpc.mpc-sa.mpc-sa-sdk.src.main.java.com.welab.wefe |
...
This flowchart illustrates the hierarchical structure of the MPC Secure Aggregation SDK in the WeFe project. Starting from the root directory 'wefe', it expands progressively to modules such as 'mpc', 'sa', 'sdk', and ultimately displays specific implementation classes and configuration files. It highlights two transfer variable implementation methods under the 'transfer' module (SecureAggregationTransferVariable and HttpTransferVariable), as well as the core SecureAggregation class and ServerConfig configuration class.
